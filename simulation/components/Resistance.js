...
Resistance.prototype.Schema =
	...
	// HC-Code
	"<optional>" +
		"<element name='BlockRating' a:help='Block chance for units which completely ignores incoming ranged damage'><ref name='nonNegativeDecimal'/></element>" +
	"</optional>" +
	"<optional>" +
		"<element name='StunResistance' a:help='Resistance to stun in percentage'><ref name='nonNegativeDecimal'/></element>" +
	"</optional>";
	// HC-End
...
Resistance.prototype.Init = function()
{
	...
	//HC-Code
	this.InitHyrule();
	Engine.QueryInterface(SYSTEM_ENTITY, IID_Timer).SetTimeout(this.entity, IID_Resistance, "PostInit", 1, {});
	//HC-End
};
